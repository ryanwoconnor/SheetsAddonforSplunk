...
from SheetsAddonforSplunk_app.modular_input import Field, ModularInput, DurationField, BooleanField, DeprecatedField
...
from SheetsAddonforSplunk_app import GoogleLookupSync, SpreadsheetInaccessible
...
class GoogleSpreadsheets(ModularInput):
    ...
    def get_credentials_from_oauth_file(self, service_account_key_file):
        ...
        # Load the key file
        json_key = json.load(open(make_splunkhome_path(['etc', 'apps', 'SheetsAddonforSplunk', 'service_account_keys', os.path.basename(service_account_key_file)])))
