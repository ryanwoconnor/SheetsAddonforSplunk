...
class GoogleDriveApp(admin.MConfigHandler):
    ...
    def handleList(self, confInfo):
        ...
        my_app = "SheetsAddonforSplunk"

        try:

            sessionKey = self.getSessionKey()
            get_path = '/servicesNS/nobody/SheetsAddonforSplunk/storage/passwords?output_mode=json'
    ...
    def handleEdit(self, confInfo):
        ...
        if method == 'post':
            ...
            try:
                sessionKey = self.getSessionKey()
                post_path = '/servicesNS/nobody/SheetsAddonforSplunk/storage/passwords?output_mode=json'
            ...
            try:
                sessionKey = self.getSessionKey()
                post_path = '/servicesNS/nobody/SheetsAddonforSplunk/storage/passwords/' + entity
